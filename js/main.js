...
document.addEventListener('input', function(event) {
    if (event.target.dataset.counter != undefined) {
        ...
        let HelpOperation_1 = Number((T_2 / N_2) * N_4 + (T_3 / N_3) * N_4 + (T_7 / N_1) * N_4 + ((T_4 + T_11 + T_12) / M_1) * N_4).toFixed(4);
        let T_0 = Number((T_2 / N_2) * N_4 + (T_3 / N_3) * N_4 + (T_7 / N_1) * N_4 + ((T_4 + T_11 + T_12) / M_1) * N_4 + T_6 + N_4 / V_1).toFixed(4);
        let K_1 = Number((T_10 * 60) / (T_10 * 60 - T_1 - T_5 - T_8 - T_9)).toFixed(4);
        let T_ = Number(T_0 * K_1).toFixed(4);
        let P_1 = Number((T_10 * 60 - T_1 - T_5 - T_8 - T_9) / ((T_2 / N_2) + (T_3 / N_3) + (T_7 / N_1) + ((T_4 + T_11 + T_12) / M_1) + (T_6 / N_4) + (1 / V_1))).toFixed(4);
